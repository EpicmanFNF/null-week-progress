...
function onCreatePost()
{
	...
	intro.load(Paths.video('momLaugh'), [FunkinVideoSprite.muted]); 	// Change the name in parenthesis to be your file name (Assuming it's not in any folders other then video)
...
function onStepHit()
{
    if (curStep == 255) 	// Change this to the step you want it to start on
    {

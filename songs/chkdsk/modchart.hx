...

{
    ...
    numericForInterval(672, 928, 2, function(step){
        ...
        modManager.queueSet(step, "transform0Z", 0.3 * counter);
        modManager.queueSet(step, "transform3Z", 0.3 * counter);
        modManager.queueEase(step, step+2, "transform0Z", 0, 'circOut');
        modManager.queueEase(step, step+2, "transform3Z", 0, 'circOut');

        modManager.queueSet(step+2, "transform1Z", 0.3 * counter);
        modManager.queueSet(step+2, "transform2Z", 0.3 * counter);
...
numericForInterval(992, 1248, 2, function(step){

            modManager.queueEase(step + 2, step + 4, "transformY", 0, 'quadIn');
            modManager.queueSet(step, "confusion", 11.25 * f);
            ...
            modManager.queueSet(step, "confusion", 22.5* f);
            ...
            modManager.queueEase(step, step + 4, "xmod", 0.9, "quadOut");
            modManager.queueSet(step, "confusion", 35 * f);
